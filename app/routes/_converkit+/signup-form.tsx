...
export function ConverkitSignupForm() {
	...
	return (
		<section className="bg-muted py-16 md:py-44">
			<div className="container-narrow grid grid-cols-3 gap-x-24">
				<div className="col-span-3 md:col-span-2">
					<h2 className="mb-8 text-4xl lg:text-5xl">
						Get helpful content straight to your inbox
					</h2>
					<div className="mb-8 flex flex-col gap-y-4 text-lg font-light">
						<p>
							You'll be notified when I publish any new content, and you can
							reply to the emails with any questions or comments you might have.
						</p>
						<p>
					...
					{!lastSubmission ? (
						...
						<div className="mb-8 flex flex-col gap-y-2 rounded-md border-2 border-accent-foreground bg-accent-foreground/20 p-6 text-foreground">
							<p className="text-lg">
								You've signed up successfully. Thanks! 🎉
							</p>
