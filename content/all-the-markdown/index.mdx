---
slug: all-the-markdown
title: All the markdown
date: 2024-03-18
description: A markdown file with all the markdown syntax
categories:
  - Writing
  - Blog
imageUrl: ./banner.jpg
...
This is a longer TypeScript piece of code:
		...
		<main>
			<div className="container-narrow">
				<div className="pb-6 pt-12">
					<Link
						to="/blog"
						className="ring-offset-background hover:text-accent-foreground focus-visible:ring-ring inline-flex items-center rounded-md text-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
					>
